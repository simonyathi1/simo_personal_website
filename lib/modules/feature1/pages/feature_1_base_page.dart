...
class Feature1BasePage extends StatefulWidget {
  const Feature1BasePage({Key? key}) : super(key: key);

  @override
  State<Feature1BasePage> createState() => _BerriesListPageState();
}

class _BerriesListPageState extends State<Feature1BasePage> {
  final berryRepository = Modular.get<Feature1Repository>();
          ...
          child: Builder(builder: (context) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (_, index) {
                ...
                return ListTile(
                  onTap: () => Modular.to.pushNamed('/home/feature1/detail',
